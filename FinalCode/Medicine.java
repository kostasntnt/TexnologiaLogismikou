...
import com.package1.Allergy;

public class Medicine {
  private String name_med;
  private int milligram_med;
  private int id_med;
  ...
  public Medicine(String name_med,String activesub_med,int milligram_med,int id_med)
  {
  ...
  public void setname_med(String name_med) {
	...
	public int getmilligram_med() {
    return milligram_med;
  }
  public void setmilligram_med(int milligram_med) {
    this.milligram_med = milligram_med;
	}
