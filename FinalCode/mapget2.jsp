  ...
  <head>
    ...
    <style type="text/css">
      ...
      body {
       ...
       <%
     String getcor2 =request.getParameter("pha15");
...
String sql = "SELECT * FROM pharmacy WHERE name_pha='"+getcor2 +"'";
 ResultSet rs = stmt.executeQuery(sql);
 while(rs.next()){
          out.println("Lat is :");
          out.println(rs.getString("lat_pha"));
          out.println("<br>");
                    out.println("Long is :");
          out.println(rs.getString("lng_pha"));
          out.println("<br>");
                float f = Float.parseFloat(rs.getString("lng_pha"));
                float f2 = Float.parseFloat(rs.getString("lat_pha"));
out.println(f);
out.println(f2);


session.setAttribute("sessname1",rs.getString("lng_pha")); 

session.setAttribute("sessname",rs.getString("lat_pha")); 
