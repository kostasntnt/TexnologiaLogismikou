...
<textarea id="w3mission" rows="4" cols="70">
   <%
     String getall =request.getParameter("pat1");
  //   out.println(getlastname);
          try{
         java.sql.Driver d=new com.mysql.jdbc.Driver();
        Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/texnologialog", "root" ,"");
       ...
       stmt = con.createStatement();
String sql = "SELECT * FROM allergy INNER JOIN patient ON allergy.id_all=patient.id_all WHERE lastname_pat='"+getall +"'";
 ResultSet rs = stmt.executeQuery(sql);
 while(rs.next()){
          out.println(rs.getString("name_all")+(" : ")+(rs.getString("desc_all")));
...
<textarea id="w3mission" rows="4" cols="70">
  <%
     String getdisease =request.getParameter("pat1");
  //   out.println(getlastname);
          try{
         java.sql.Driver d=new com.mysql.jdbc.Driver();
        Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/texnologialog", "root" ,"");
       ...
       stmt = con.createStatement();
String sql = "SELECT * FROM dis INNER JOIN patient ON dis.id_dis=patient.id_dis WHERE lastname_pat='"+getdisease +"'";
 ResultSet rs = stmt.executeQuery(sql);
 while(rs.next()){
          out.println(rs.getString("name_dis"));
